...
bool test_circShift(void)
{
    ...
    cout << "circShift seems to be correct!"<< endl;
    return true;
}
...
bool test_DFTReal2Complex()
{
    ...
    cout << "DFTReal2Complex seems to be correct!"<< endl;
    return true;
}
...
bool test_IDFTComplex2Real()
{
    ...
    cout << "IDFTComplex2Real seems to be correct!"<< endl;
    return true;
}
...
bool test_computeInverseFilter()
{
    ...
    cout << "computeInverseFilter seems to be correct!"<< endl;
    return true;
}
...
bool test_applyFilter()
{
    ...
    cout << "applyFilter seems to be correct!"<< endl;
    return true;
}
...
bool test_inverseFilter()
{
    ...
    cout << "inverseFilter seems to be correct!"<< endl;
    return true;
}
...
bool test_computeWienerFilter()
{
    ...
    cout << "computeWienerFilter seems to be correct!"<< endl;
    return true;
}
...
bool test_wienerFilter()
{
    ...
    cout << "wienerFilter seems to be correct!"<< endl;
    return true;
}
